...
export default function Header(props) {
    return (
        <header className="sticky top-0 z-49 flex w-full bg-white drop-shadow-1 dark:bg-boxdark duration-300 ease-linear dark:drop-shadow-none">
            <div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
                <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
                    ...
                    <button
                        ...
                        className="z-49 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark duration-300 ease-linear dark:bg-boxdark lg:hidden"
                    >
