        ...
        <nav className="bg-sidebar dark:bg-boxdark duration-300 ease-linear h-full py-4 px-4 flex flex-col justify-start items-start">
          <div className='w-full'>
            <SidebarLinkGroup activeCondition={pathname === '/' || pathname.includes('/')}>
              {(handleClick, open) => {
                return (
                  <NavLink to="/" className={`${(pathname === '/' || pathname.includes('/')) && 'bg-graydark dark:bg-meta-4'} group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4`}>
          ...
          <div className="w-full">
            ...
            <SidebarLinkGroup activeCondition={pathname === '/' || pathname.includes('/')}>
              {(handleClick, open) => {
                return (
                  <NavLink to="/aluno" className={`${(pathname === '/aluno' || pathname.includes('/aluno')) && 'bg-graydark dark:bg-meta-4'}group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
