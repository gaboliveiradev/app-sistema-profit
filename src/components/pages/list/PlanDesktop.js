                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-500">Nome: <strong>Plano Avançado</strong></div>
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-500">Tempo: <strong>7 Dias p/Semana</strong></div>
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-500">Preço: <strong>R$ 90,00</strong></div>
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-500">Tipo: <strong>Ativo</strong></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
