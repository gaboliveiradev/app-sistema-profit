            ...
            <div className='flex items-center justify-between'>
                <div className="py-6 md:py-0 sm:px-4 w-[100%] z-40 md:top-0 flex flex-row items-center justify-between">
                    ...
                    </div>
                    {
                        (pathname === URL_LIST) && (
                            <div className='px-4 flex flex-row items-start justify-start md:mx-0'>
                                <button onClick={(e) => navigate('/plano')} className='uppercase bg-primary-color px-4 py-1 rounded-md border-2 border-primary-color hover:bg-primary-color font-medium text-white hover:text-white duration-150'>Adicionar</button>
                            </div>
                        )
                    }
                </div>
